...
export const TURN_END_SEAT_REST_MIN_SEC = 10.0;
export const TURN_END_SEAT_REST_MAX_SEC = 30.0;
...
export const TOOL_OVERLAY_BG_PERMISSION = 'rgba(204, 167, 0, 0.08)';
export const TOOL_OVERLAY_BG_ACTIVE = 'rgba(55, 148, 255, 0.06)';
export const NAMEPLATE_TEXT_COLOR = '#e8e8e8';
export const NAMEPLATE_TEXT_SHADOW = '1px 0 0 #111, -1px 0 0 #111, 0 1px 0 #111, 0 -1px 0 #111';
export const NAMEPLATE_VERTICAL_OFFSET_PX = 20;
